...
Measured by [`bench/gpu_linalg_bench.cpp`](bench/gpu_linalg_bench.cpp); reproduce with `python3 bench/emit_tables.py --out docs/bench/gpu-device-throughput.md`.
...
Measured by [`bench/crossover.py`](bench/crossover.py); reproduce with `python3 bench/crossover.py --out docs/bench/gpu-host-device-crossover.md`.
